...
const Login = () => {
    ...
    const { user, loading, setLoading, setClick } = useContext(MyAuthContext);
    ...
    const handleLogin = async (e) => {
        ...
        if (res.data?.login) {
            ...
            const loggedUser = res.data?.loginUser;
    ...
    return (
        <div className="bg-gradient-to-r from-blue-50 to-blue-400 w-full">
            <div className="mx-auto px-4 p-4 sm:px-6 lg:px-8 min-h-screen flex justify-center items-center">
                <div className="bg-[#003343] w-full lg:w-[450px] rounded-lg">
                    <form onSubmit={handleLogin} className="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
                        ...
                        <p className="text-center text-sm text-gray-400">
                            No account?
                            <Link to='/regi' className="underline">Sign up</Link>
                        </p>
                    </form>
                </div>
            </div>
